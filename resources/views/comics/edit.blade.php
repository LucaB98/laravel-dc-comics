                ...
                <div class="row flex my-3">
                    <div class="col-create">
                        <div class="my-3">
                            ...
                            <input type="text" name='title' class="form-control" id="title" placeholder="Es:Uomo d'acciaio" value="{{ old('title', $comic->title)}}">
                        </div>
                    </div>
                    <div class="col-create">
                        <div class="my-3">
                            <label for="thumb" class="form-label">Immagine</label>
                            <input type="url" name='thumb' class="form-control" id="thumb" placeholder="Es:http//..." value="{{ old('thumb', $comic->thumb)}}">
                        </div>
                    </div>
                    <div class="col box-img">
                        <img src="{{$comic->thumb ?? 'https://marcolanci.it/boolean/assets/placeholder.png'}}" alt="" id="preview" class="img-fluid">
                    </div>
                </div>
                <div class="row my-3">
                    <div class="col-create">
                ...
                <div class="row flex my-3">
                    <div class="col-create">
                        <div class="my-3">
                            ...
                            <input type="text" name='type' class="form-info" id="type" placeholder="Es:'action" value="{{ old('type', $comic->type)}}">
                        </div>
                    </div>
                    <div class="col-create">
                        <div class="my-3">
                            <label for="series" class="form-label">series</label>
                            <input type="text" name='series' class="form-info" id="series" placeholder="Es:marvel" value="{{ old('series', $comic->series)}}">
                        </div>
                    </div>
                    <div class="col-create">
                        <div class="my-3">
                            <label for="sale_date" class="form-label">data</label>
                            <input type="text" name='sale_date' class="form-info" id="sale_date" placeholder="Es: 2022/10/16.." value="{{ old('sale_date', $comic->sale_date)}}">
                        </div>
                    </div>
                    <div class="col-create">
                        <div class="my-3">
                            <label for="price" class="form-label">prezzo</label>
                            <input type="text" name='price' class="form-info" id="price" placeholder="Es:6.99" value="{{ old('price', $comic->price)}}">
                        </div>
                    </div>    
                </div>
                <div class="row flex">
                    <div class="col-create">
                        <div class="my-3">
                            ...
                            <input type="text" name='artists' class="form-info" id="artists" placeholder="stan lee" value="{{ old('artists', $comic->artists)}}">
                        </div>
                    </div>
                    <div class="col-create">
                        <div class="my-3">
                            <label for="writers" class="form-label">Scrittore</label>
                            <input type="text" name='writers' class="form-info" id="writers" placeholder="stan lee" value="{{ old('writers', $comic->writers)}}">
                        </div>
                    </div>
                </div>
                <div class="row flex row-btn">
                    <button class="btn-create">Salva</button>
                </div>
            </form>
        </div>
    </div>
